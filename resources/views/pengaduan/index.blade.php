        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="laporan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="laporan">Cetak Data</a></li>
              </ul>
            </div>
          </li>
          @endif 
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="row">
                ...
                <div class="card mt-5">
                <div class="card-body">
                <h3 class="font-weight-bold"><center>DATA PENGADUAN</center></h3>
                <hr color="black">
                    ...
                    <table class="table table-bordered table-hover table-striped" id="datatables">  
                        <thead>
                            <tr>
                                ...
                                <th><font color="white"><b>NIK</b></font></th></th>
                        ...
                        <tbody>
                            ...
                            <td>{{ date('d F Y', strtotime($p->tgl_pengaduan)) }}</td>
                                ...
                                <td>
                                    ...
                                    @if ($p->status == '0')
                                      <a href="/pengaduan/edit/{{ $p->id_pengaduan }}"><i class="fa-solid fa-pen-to-square fa-xl" style="color: #030303;"></i></a>
                                    @elseif ($p->status == 'proses')
                                      <a href="/pengaduan/status/{{ $p->id_pengaduan }}"><i class="fa-solid fa-thumbs-up fa-xl"></i></a>
                                    @else
                                    <a href="/pengaduan/show/{{ $p->id_pengaduan }}"><i class="fa fa-eye fa-xl"></i></a>
                                    @endif
                                    <a href="/pengaduan/destroy/{{ $p->id_pengaduan }}" onclick="return confirm('Apakah Anda Ingin Menghapus?')"><i class="fa-solid fa-trash fa-xl" style="color: #ff0000;"></i></a>
