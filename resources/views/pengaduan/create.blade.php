        ...
        <div class="content-wrapper">
          ...
          <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><center>Silahkan Isi Terlebih Dahulu Pengaduanmu</center></h4>
                  <form method="post" action="/pengaduan/store" enctype="multipart/form-data">
 
                        {{ csrf_field() }}
                    <div class="form-group">
                      <label for="tgl_pengaduan">Tanggal Pengaduan</label>
                      <input type="date" class="form-control" name="tgl_pengaduan" placeholder="tgl_pengaduan">
                    ...
                    <div class="form-group">
                      ...
                      <p><h5><font color="red"> *Tambahkan laporan beserta alamat yang jelas dan lengkap* </font></h5></p>
                    ...
                    <div class="input-group mb-3">
                      <tr>
                        <td>
                          <input type="file" name="foto[]" id="inputGroupFile" multiple>
                          @if($errors->has('foto'))
                          <div class="text-danger">
                            {{ $errors->first('foto')}}
                          </div>
