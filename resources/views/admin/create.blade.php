        ...
        <div class="content-wrapper">
          ...
          <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><center>Silahkan Isi Terlebih Dahulu</center></h4>
                  <form method="post" action="/user/store" enctype="multipart/form-data">
 
                        {{ csrf_field() }}
                    <div class="form-group">
                      <label for="tgl_pengaduan">NIK</label>
                    ...
                    <div class="form-group">
                       <label class="form-label" for="role">Role</label>
                            <select name="role" id="role" class="selectpicker form-control" data-style="py-0"> 
