          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              ...
              <!-- <div class="col-12 col-xl-8 mb-4 mb-xl-0"> -->
                  <h3 class="font-weight-bold"><center>EDIT PETUGAS</center></h3>
                  <hr color="black">
                <!-- </div> -->
                <br/>
                <form class="form-horizontal" enctype="multipart/form-data" action="/user/update/{{ $user->id }}" method="POST"> 
                  ...
                  {{ method_field('PUT')}}
                        ...
                        <div class="form-group">
                            <label>NIK</label>
                            <input type="date" value="{{ $user->nik }}" class="form-control" name="nik" disabled>
                      @if($errors->has('nik'))
                      ...
                      @endif 
                       ...
                       <label class="form-label" for="role">Role</label>
                            <select name="role" id="role" value="{{ $user->role }}" class="selectpicker form-control" data-style="py-0"> 
